  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        primary: {
          DEFAULT: 'hsl(var(--primary, 221 43% 34%))', // #1E3A8A
          foreground: 'hsl(var(--primary-foreground, 0 0% 100%))',
        },
        secondary: {
          DEFAULT: 'hsl(var(--secondary, 48 97% 63%))', // #FACC15
          foreground: 'hsl(var(--secondary-foreground, 222 47% 11%))',
        },
        destructive: {
          DEFAULT: 'hsl(var(--destructive, 0 72% 54%))', // #DC2626
          foreground: 'hsl(var(--destructive-foreground, 0 0% 100%))',
        },
        muted: {
          DEFAULT: 'hsl(var(--muted, 220 16% 96%))',
          foreground: 'hsl(var(--muted-foreground, 222 20% 40%))',
        },
        accent: {
          DEFAULT: 'hsl(var(--accent, 221 43% 34%))',
      ...
      animation: {
        ...
        'subtle-gradient-bg': 'subtle-gradient-bg 25s ease infinite',
...
// To change your brand colors, edit the HSL values in globals.css or override the --primary, --secondary, --destructive variables.
