    ...
    <section id="contact" className="w-full py-20 md:py-32 bg-background">
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <Card className="text-center transform hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-primary/20">
            <CardHeader>
            ...
            <CardContent>
              <a href="mailto:support@achrakat.com" className="text-lg text-muted-foreground hover:text-primary">
          ...
          <Card className="text-center transform hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-primary/20">
            ...
            <CardContent>
              <a href="tel:+966123456789" className="text-lg text-muted-foreground hover:text-primary" dir="ltr">
                +966 123 456 789
              </a>
            </CardContent>
          </Card>
        ...
        <div className="mt-16">
          ...
          <div className="flex justify-center gap-4">
            <Button variant="outline" size="icon" className="rounded-full w-12 h-12 hover:bg-primary hover:text-primary-foreground" asChild>
