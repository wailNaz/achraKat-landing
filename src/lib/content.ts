export const content = {
  ar: {
    ...
    hero: {
      title: 'أشرقت: تسوّق اليوم وادفع لاحقًا بثقة',
      subtitle: 'اكتشف تجربة تسوّق مبتكرة مع حلول تقسيط مرنة وسهلة. كل ما تحتاجه أصبح في متناول يدك مع خطط دفع تناسب ميزانيتك وتمنحك راحة البال.',
      appStoreButton: 'تنزيل من App Store',
      googlePlayButton: 'تنزيل من Google Play',
      discoverMore: 'استكشف المزيد من المزايا',
    },
    explanation: {
      title: 'كيف يعمل تطبيق أشرقت؟',
      subtitle: 'اتبع أربع خطوات بسيطة لتجربة تسوّق سلسة وذكية. استمتع بالمرونة والشفافية في كل عملية شراء.',
      steps: [
    ...
    screenshots: {
      title: 'جولة في منصتنا الذكية',
      subtitle: 'استكشف سهولة الاستخدام والتصميم العصري في تطبيق المستخدمين ولوحة تحكم الشركاء. واجهة بديهية لكل احتياج.',
      userAppTab: 'تطبيق المستخدم',
      partnerPanelTab: 'لوحة الشريك',
    },
    testimonials: {
      title: 'آراء عملائنا وشركائنا',
      subtitle: 'قصص نجاح وشهادات نفتخر بها من مستخدمينا وشركائنا في النجاح.',
      items: [
        {
          name: 'سارة عبدالله',
          title: 'عميلة راضية',
    ...
    faq: {
      ...
      subtitle: 'هل لديك استفسار؟ هنا تجد كل الإجابات حول خدمات أشرقت وكيفية الاستفادة منها.',
      items: [
    ...
    partnerRegistration: {
      ...
      subtitle: 'وسّع نطاق أعمالك وكن جزءًا من منظومة أشرقت. قدّم منتجاتك لملايين المستخدمين واستفد من حلول دفع مبتكرة ودعم تسويقي متكامل.',
